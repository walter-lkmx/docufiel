    ...
    <default-page>
      ...
      <twin-columns class="contact">
        ...
        <template class="contact__map" v-slot:right>
          <iframe width="600" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=Av.%20Ryerson%20%23454%20Zona%20Centro%2C%20CP%2022800%20Ensenada%2C%20B.C.&key=AIzaSyA1tse6UzOTCX-0enW45ZDC0XMVTqL2_L0" allowfullscreen></iframe>
        </template>
      </twin-columns>
